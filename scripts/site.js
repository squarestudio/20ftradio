  ...
  window.addEventListener('DOMContentLoaded', function () {
    ...
    if(Y.one('.header-block-content')){
      ...
      if(header_content.one('.sqs-donate-button')){
        var a = Y.Node.create('<a href="https://secure.squarespace.com/commerce/donate?donatePageId='+header_content.one('.sqs-donate-button').getAttribute('data-donate-page-id')+'"></a>');
