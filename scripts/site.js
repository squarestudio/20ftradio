...
(function() {
  ...
  if(Y.one('.header-block-content')){
    ...
    if(header_content.one('.sqs-svg-icon--list')){
      header_content.one('.socialaccountlinks-v2-block .sqs-svg-icon--list').append('<a href="https://www.mixcloud.com/20ftradio/" target="_blank" class="sqs-svg-icon--wrapper mixcloud"></a>');
    }
