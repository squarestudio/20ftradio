                ...
                success: function (i, data) {
                    if (data.status == 200 && data.readyState == 4) {
                       var html = data.responseText.replace(/src=/g, 'data-href=');
                        ...
                        console.log(status_html.one('.newscontent table[cellpadding=4] tr:last-child .streamdata'))
                        var current_song = status_html.one('.newscontent table[cellpadding=4]  td:last-child').get('text');
