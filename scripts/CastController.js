window.Template.Controllers.CastController = function (element) {
    ...
    function initShoutCast() {
        if (shoutCastUrl) {
            ...
            if (!shoutcastPlayer) {
                YshoutcastPlayer = Y.Node.create('<video id="shoutcastPlayer" title="20FT Radio" class="stream-player"  poster="https://www.20ftradio.net/assets/icon.png" preload="auto" playsinline -webkit-playsinline name="media"><source src="' + shoutCastUrl + '" type="audio/mpeg"></video>');
            }
