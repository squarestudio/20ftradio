window.Template.Controllers.CastController = function(element) {
    ...
    function initShoutCast() {
        if (shoutCastUrl) {
            ...
            if (!shoutcastPlayer) {
                YshoutcastPlayer = Y.Node.create('<video autoplay allow="autoplay" id="shoutcastPlayer" src="' + shoutCastUrl + '" title="20FT Radio" class="stream-player"  poster="https://www.20ftradio.net/assets/icon.png" preload="auto" playsinline -webkit-playsinline name="media" crossorigin="anonymous"></video>');
            }
