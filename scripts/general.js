    ...
    body.delegate('click', function(e) {
        ...
        if (url && ancestor.hasClass('playing')) {
            ...
            if (!currentIframe || currentIframe && currentIframe.getAttribute('data-src') !== url) {
                ...
                currentIframe = Y.Node.create('<iframe data-src="'+url+'" class="mixcloud-content" width="100%" height="60" src="https://www.mixcloud.com/widget/iframe/?hide_cover=1autoplay=1&mini=1&feed=' + (i = encodeURIComponent(decodeURIComponent(url))) + '" frameborder="0" allow="autoplay"></iframe>')
