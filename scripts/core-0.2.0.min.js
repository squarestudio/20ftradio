!function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.SQS = t() : e.SQS = t()
}(this, function () {
    return function (e) {
        function t(o) {
            if (a[o])return a[o].exports;
            var r = a[o] = {exports: {}, id: o, loaded: !1};
        ...
        var r = a(1), n = o(r), c = a(2), l = o(c), u = a(3), f = o(u), i = {
        ...
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        var a = Static.SQUARESPACE_CONTEXT.authenticatedAccount, o = {all: {callbacks: []}}, r = {
            getValue: function (e) {
        ...
        window.Y.Global && a && window.Y.Global.on("tweak:change", function (e) {
            var t = e.getName(), a = {name: t, value: e.config && e.config.value || e.value};
