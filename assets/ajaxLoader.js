(function (window, document) {
    ...
    var DEFAULT_ANCHORS = 'a[href*="20ftradio.com"], a[href]:not([href^="http"]):not([href^="#"]):not([href^="/#"]):not([href^="/commerce"]):not([href^="mailto"]):not([href^="tel"]):not([href^="javascript"]):not([href*="?format"]):not(.nav-item-splash-page)';
